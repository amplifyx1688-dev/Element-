    ...
    messages: [
      {
        ...
        platformName: "Facebook Messenger",
        sender: "Amy Chen",
        content: "Hello! How much is this item?",
        timestamp: "2026-03-06T14:25:00Z",
        status: "replied",
        matchedRule: "r1",
        sentReply: "Hi！關於價格方面，請查看商品詳情頁面的標示價格。如有任何疑問歡迎繼續詢問 🙏",
        isIncoming: true,
      },
    ],
    status: "waiting",
    lastActivity: "2026-03-06T14:25:00Z",
    unreadCount: 0,
    assignedRules: ["r1"],
  },
  {
    ...
    messages: [
      {
        ...
        platformName: "蝦皮購物",
        sender: "買家 阿花",
        content: "我收到的商品有瑕疵，想要退貨",
        timestamp: "2026-03-06T14:40:00Z",
        status: "unread",
        matchedRule: "r4",
        suggestedReply: "非常抱歉造成您的不便！🙏 關於退換貨，我們提供 7 天鑑賞期。請提供：\n1. 訂單編號\n2. 問題說明\n3. 商品照片\n\n我們會盡快為您處理！",
        isIncoming: true,
      },
    ],
    status: "active",
    lastActivity: "2026-03-06T14:40:00Z",
    unreadCount: 1,
    assignedRules: ["r4"],
  },
];
